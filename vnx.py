...
class ArrayConfiguration(object):
    """
    Wrapper object for EMC VNX Array Configuration
    """
...
class EMCVnxCLICmdError(Exception):
    """
    """
...
class DeviceException(Exception):
    ...
    :param ArrayConfiguration configuration: The configuration related to
        backend device.
    """
...
def vnx_from_configuration(cluster_id, xms_user, xms_password, xms_ip):
    ...
    :param xms_user:
    :param xms_password:
    :return:EMCVnxBlockDeviceAPI object
    """
    return EMCVnxBlockDeviceAPI(
...
class CommandLineHelper(object):
    ...
    def create_lun_by_cmd(self, cmd, name):
            ...
            # or other unexpected states.
                ...
                msg = _("Volume %(lun_name)s was created in VNX, but in"
                        " %(lun_state)s state."
                             ...
                             'lun_state': lun_state}
                raise VolumeBackendAPIException(data=msg)
        ...
        self._wait_for_a_condition(lun_is_ready,
                                   ...
                                   INTERVAL_5_SEC,
                                   lambda ex:
                                   isinstance(ex, EMCVnxCLICmdError))
    ...
    def verify_lun_migration(self, src_id):
            ...
            if rc == 0:
                ...
                if ("FAULTED" in current_state or
                    ...
                    reason = _("Migration of LUN %s has been stopped or"
                               " faulted.") % src_id
                    raise VolumeBackendAPIException(data=reason)
        ...
        try:
            ...
            self._wait_for_a_condition(
                ...
                type(ex) is not VolumeBackendAPIException)
...
class EMCVnxBlockDeviceAPI(object):
    ...
    def __init__(self, cluster_id, prtcl, configuration,
    ...
    def delete_volume(self, blockdevice_id, force_delete=False):
        ...
        except EMCVnxCLICmdError:
            lun_id = self.get_lun_by_name(name)
...
def emc_vnx_api(cluster_id, prtcl, configuration=None):
    configuration.append_config_values(loc_opts)
    return EMCVnxBlockDeviceAPI(cluster_id, prtcl, configuration=configuration)
    # return EMCVnxBlockDeviceAPI(prtcl,
    # configuration=ArrayConfiguration(xms_user, xms_password, xms_ip),
    #   cluster_id=cluster_id,
    #   compute_instance_id=unicode(socket.gethostname()),
    #   allocation_unit=1
